...
% ----------------------------------------------------------
%\capa % capa removida por enquanto (descomentar quando finalizar)
\folhaderosto
% ----------------------------------------------------------
...
%\include{B.PreTextual/ficha} % ficha catalografica pendente (Biblioteca BAVR)

% --- Folha de aprovacao (banca), dedicatoria, agradecimentos e epigrafe ---
% --- removidos por enquanto; descomentar quando definidos ---
% \newcommand{\spc}{0.25cm}
% \begin{folhadeaprovacao}
% 	\vspace{\spc}
% 	\assinatura{Prof. Dr. Nome}{instituição}
% 	\vspace{\spc}
% 	\assinatura{Prof. Dr. Nome}{instituição}
...
\include{C.Chapters/03.Methodology}
\include{C.Chapters/04.Serial}
\include{C.Chapters/05.GPU}
\include{C.Chapters/90.Results}
%\include{C.Chapters/99.Conclusion}  % Conclusão será escrita depois
